...
angular.module("myApp", ['ngSanitize','ngNotify', 'ngQuill', 'angularFileUpload', 'angularUtils.directives.dirPagination']).filter('roundup', function () {
	return function (value) {
		return Math.ceil(value);
	};
}).config(function(paginationTemplateProvider) {
    paginationTemplateProvider.setPath(PATH+'node_modules/angular-utils-pagination/dirPagination.tpl.html');
